        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                if(m_bbIpcRequest1==null){
                    ...
                    boolean register = m_bbIpcRequest1.register();
                    Log.d(TAG, "run: 注册状态 = "+register);
                }
                try {
...
//                    Log.d(TAG, "客户端1 收到的数据: "+execute);
                    ...
                    m_bbIpcRequest1.enqueue(
                        ...
                        public void onFailure(IOException ioException) {
                            ...
                            Log.d(TAG, "客户端1 异常: "+ioException);
                            Log.d(TAG, "客户端1 异常: "+ Arrays.toString(ioException.getStackTrace()));
                        }
...
//        Log.d(TAG, "onClick1: "+webSocketServer);
    }
...
//        webSocketServer.stopServer();
    ...
    public void xiezai_1(View view) {
        boolean b = m_bbIpcRequest1.unRegister("客户端1");
        if (b){
            m_bbIpcRequest1=null;
            Log.d(TAG, "xiezai_1: 卸载成功");
        }else{
            Log.d(TAG, "xiezai_1: 卸载失败");
        }
    }
}